...
<body>
    ...
    <div class="background">
        ...
        <form class="create" action="{{route('edit',$product->id)}}" method="post"  enctype="multipart/form-data" >
        @method('PUT')
      @csrf
...
<span style="color: gray;"class="text-danger">@error('product_price'){{$message}} @enderror</span>
    ...
    <input type="number" name="category_id" id="category_id" value="{{$product->category_id}}" >
