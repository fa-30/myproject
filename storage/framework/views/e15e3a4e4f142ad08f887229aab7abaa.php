...
<body>
    ...
    <div class="background">
        ...
        <form class="create" action="<?php echo e(route('store')); ?>" method="post"  enctype="multipart/form-data" >
      <?php echo csrf_field(); ?>
      <label for="product_name">Product Name</label>
    <input type="text" name="product_name" id="product_name" value="<?php echo e(old('product_name')); ?>" placeholder="name">
...
unset($__errorArgs, $__bag); ?></span>
    ...
    <input type="number" name="product_price" id="product_price" value="<?php echo e(old('product_price')); ?>"placeholder="price" >
...
unset($__errorArgs, $__bag); ?></span>
    ...
    <input type="number" name="category_id" id="category_id" value="<?php echo e(old('category_id')); ?>" placeholder="catigory" >
...
</html><?php /**PATH C:\Users\dell\Desktop\iti_project\example\resources\views/create.blade.php ENDPATH**/ ?>